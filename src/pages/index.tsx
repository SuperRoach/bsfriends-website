      ...
      <section className="py-24 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
            BigscreenVR is a virtual reality social platform where you can watch movies, play games, and hang out with friends in virtual environments. It&apos;s nothing to do with the <a href="https://store.bigscreenvr.com/">Bigscreen Beyond</a>, which is a headset that is built for VR (and is pretty neat as well). BigscreenVR is for well, VR experiences.
          </p>
          <div className="mb-8">
            <a
              href="https://bigscreenvr.com"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-colors duration-200"
            >
              Learn More at BigscreenVR.com
